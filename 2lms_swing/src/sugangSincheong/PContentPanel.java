...
public class PContentPanel extends JPanel {
	...
	public void initialize(VUser vUser) {
		...
		this.pSincheong.initialize(vUser.getUserId()+EConfiguration.sinheongFilePostfix.getText());
	...
	public void save() {
		...
		this.pSincheong.save(vUser.getUserId()+EConfiguration.sinheongFilePostfix.getText());		
	}
